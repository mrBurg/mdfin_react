...
export const ProductSelector: FC<TProductSelectorProps> = ({
  ...
  <div className={classNames(style.productSelector, className)}>
    <div className={classNames(style.item, style.calculator)}>
      ...
      deleniti voluptates libero quidem delectus, maxime vero odit perspiciatis
      commodi praesentium nisi, eveniet modi magnam, ducimus doloremque! Odit
      facere sapiente nostrum.
    </div>
