...
export class Job extends PureComponent<TJob> {
  ...
  private async submitForm() {
    ...
    if (userStore) {
      ...
      userStore.postWizardData_Job(newData);
  ...
  public render(): ReactElement | null {
    ...
    if (this.state.isRender && pageStore) {
      return (
        <ClientTabs>
          <form className={style.job} onSubmit={this.onSubmitHandler}>
            <h2 className={style.title}>{staticData.title}</h2>

            <div className={style.fields}>
              <SelectWidget
                name={FIELD_NAME.SOCIAL_STATUS_ID}
                value={this.state.userDataJob.socialStatus_id}
              ...
              <SelectWidget
                ...
                value={this.state.userDataJob.education_id}
                className={style.input}
              ...
              <input
                ...
                value={this.state.userDataJob.companyName || ''}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
                })}
              ...
              <SelectWidget
                ...
                value={this.state.userDataJob.industry_id}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              <SelectWidget
                ...
                value={this.state.userDataJob.industryDetailed_id}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              <SelectWidget
                ...
                value={this.state.userDataJob.posType_id}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              <input
                ...
                value={this.state.userDataJob.posName || ''}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              />
              <div
                className={classNames(style.workPeriod, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
                })}
              >
                <p className={style.workPeriodTitle}>{staticData.workPeriod}</p>
                <input
                  name={FIELD_NAME.WORK_YEARS}
                  value={this.state.userDataJob.jobLastPeriodYear || ''}
                  className={style.input}
                ...
                <input
                  ...
                  value={this.state.userDataJob.jobLastPeriodMonth || ''}
                  className={style.input}
                  type={INPUT_TYPE.NUMBER}
              ...
              <InputMask
                ...
                value={this.state.userDataJob.contact?.phoneNumber || ''}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              <input
                ...
                value={this.state.userDataJob.contact?.name || ''}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              <SelectWidget
                ...
                value={this.state.userDataJob.contact?.type_id}
                className={classNames(style.input, {
                  [style.hidden]: !~[1, 2, 3, 4, 5].indexOf(
                    this.state.userDataJob.socialStatus_id!
                  ),
              ...
              <input
                ...
                value={this.state.userDataJob.income || ''}
                className={style.input}
                type={INPUT_TYPE.NUMBER}
